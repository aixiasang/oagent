...
def execute_func(tool_name:str,args:dict):
    try:
...
class OpenaiLLM(BaseModel):
    def __init__(self,llm_config:Optional[Dict]=None):
        ...
        def _chat(*args,**kwargs):
            ...
            return client.chat.completions.create(*args,**{**generation_cfg,**kwargs})
        def _embed(*args,**kwargs):
            client=OpenAI(**client_cfg)
            return client.embeddings.create(*args,**{**embedding_cfg,**kwargs})
        def _completion(*args,**kwargs):
            client=OpenAI(**client_cfg)
            return client.completions.create(*args,**{**generation_cfg,**kwargs})
    ...
    def simple_chat(self,messages:list[Message],**kwargs):
